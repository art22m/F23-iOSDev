...
var favouriteBook = Book(title: "Computer Networks", author: "Tanenbaum", pages: 1200, price: 20)
print(favouriteBook.title + " is my favorite book")
...
var laptop1 = Laptop(yearPurchased: 3)
var laptop2 = Laptop(screenSize: 1, repairCount: 2, yearPurchased: 3)
...
var myHeight = Height(centimeters: 181)
